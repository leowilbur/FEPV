...
{
    public partial class SSP_EditGoodsParametersView : UserControl, IEditGoodsParametersView
    {
        public SSP_EditGoodsParametersView()
        {
            InitializeComponent();
        ...
        public List<UIGoods> rEditGoods
        {
            get
            {
                ...
                {
                    SSP goods = (SSP)gbiz.GetInfo(row["BarCode"].ToString());
