...
namespace FEPV.Views
{
    public partial class GuestInfo : UserControl
    {
        ...
        void gridViewGuest1_Click(object sender, EventArgs e)
        {
            ...
            {
                eventShowGuestBar(this, new FEPV.Views.EGATE2.EgateArgs { EgateDictionary = paramenters });
            }
        }
        ...
        void gridViewGuest1_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                eventShowGuestView(this, new FEPV.Views.EGATE2.EgateArgs { EgateDictionary = paramenters });
            }
        }
